...
def main() -> None:
    ...
    parser.add_argument("--resolution", type=float, default=1.0,
                        help="DTM grid resolution in metres (default 1.0)")
    ...
    # -- Point density --------------------------------------------------------
    density = point_density(classified, resolution=args.resolution)
